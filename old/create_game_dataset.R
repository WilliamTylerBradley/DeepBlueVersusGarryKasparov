## This function creates the game dataset
# Parameters: string for pgn file, numeric for turning hue
create_game_dataset <- function(game_name, hue_1, hue_2) {
  pgn <- paste(readLines(here(game_name), warn = FALSE), collapse = "\n")
  chsspgn <- Chess$new()
  ...
  h_values <- seq(hue_1, hue_2, length.out = 8)
